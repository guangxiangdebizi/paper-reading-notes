...
| 第 2 站 | [02_方法_ViT回顾与蒸馏token.md](./02_方法_ViT回顾与蒸馏token.md) | §3 ViT 回顾（含 class token 洞察）、§4 蒸馏三种姿势 + 蒸馏 token | ✅ 已完成 |
| 第 3 站 | [03_实验_蒸馏分析与SOTA对比.md](./03_实验_蒸馏分析与SOTA对比.md) | 教师选择（CNN > Transformer）、蒸馏方法对比、Table 5 主表、迁移学习 | ✅ 已完成 |
| 第 4 站 | [04_训练配方与消融_结论.md](./04_训练配方与消融_结论.md) | §6 训练细节大消融（Table 8/9）、与 ViT 训练配方逐项对比、结论 | ✅ 已完成 |
